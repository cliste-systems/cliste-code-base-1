-- Editable Hello Cara demo line scenario playbooks (content only — no voice pipeline).
...
comment on table public.demo_scenarios is
  'Hello Cara demo line role-play playbooks — beats injected into worker demo prompt.';
