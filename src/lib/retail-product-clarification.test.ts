...
describe("retail product clarification", () => {
  ...
  it("prefers fresh own-brand cheapest food matches over ingredient-form noise", () => {
    const response = resolveProductSearchResponse(
      ...
      [
        { product_name: "Garnier Ultimate Blends Avocado Oil", department: "Hair Care", service_area: "grocery", fulfilment: "prepack", current_price_eur: 4.99, score: 0.9 },
        { product_name: "Biona Organic Avocado Oil", department: "Oils", service_area: "grocery", fulfilment: "prepack", current_price_eur: 8.49, score: 0.9 },
        { product_name: "Freshzilla Smashed Hass Avocado", department: "Fresh Prepared Fruit & Veg", service_area: "produce", fulfilment: "prepack", current_price_eur: 2.89, score: 0.85 },
        { product_name: "SuperValu Fresh Avocados", department: "Fresh Fruit & Vegetables", service_area: "produce", fulfilment: "prepack", current_price_eur: 1.49, score: 0.82 },
        { product_name: "SuperValu Fresh Avocado Twin Pack", department: "Fresh Fruit & Vegetables", service_area: "produce", fulfilment: "prepack", current_price_eur: 2.49, score: 0.82 },
      ],
      { intent: "price" },
    );
  ...
  it("applies the same fresh/cheapest ranking to another category", () => {
    const response = resolveProductSearchResponse(
      ...
      [
        { product_name: "SuperValu Tomato & Basil Pasta Sauce", department: "Pasta Sauce", service_area: "grocery", fulfilment: "prepack", current_price_eur: 1.19, score: 0.92 },
        { product_name: "SuperValu Fresh Tomatoes", department: "Fresh Fruit & Vegetables", service_area: "produce", fulfilment: "prepack", current_price_eur: 1.79, score: 0.82 },
        { product_name: "SuperValu Fresh Cherry Tomatoes", department: "Fresh Fruit & Vegetables", service_area: "produce", fulfilment: "prepack", current_price_eur: 2.49, score: 0.82 },
      ],
      { intent: "price" },
    );
  ...
  it("does not ask butcher counter clarification for non-counter grocery noise", () => {
    const response = resolveProductSearchResponse(
      "avocado fresh supervalu brand cheapest",
      [
        { product_name: "SuperValu Fresh Avocados", department: "Fresh Fruit & Vegetables", service_area: "produce", fulfilment: "prepack", current_price_eur: 1.49 },
        { product_name: "SuperValu Fresh Irish Pork Steak", department: "Butcher", service_area: "butcher", fulfilment: "counter", current_price_eur: 6.69 },
      ],
      { intent: "price" },
    );
