...
export function blockedCallSpokenMessage(businessName: string): string {
  ...
  return `We're unable to put you through to ${name}. This line is operated by Hello Cara on behalf of the business, and your number isn't authorised to connect. Goodbye.`;
}
